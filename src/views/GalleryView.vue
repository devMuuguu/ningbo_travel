  ...
  <div class="space-y-6">
    <div>
      ...
      <p class="text-sm text-slate-400 mb-6">
        Галт тэрэг болон нислэгийн захиалгын баталгаажуулалтын зурагнууд. Зураг
        дээр дарж томруулан харах эсвэл татан авч оффлайн үед ашиглана уу.
      </p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
      ...
      >
        <div
          class="relative overflow-hidden bg-black/40 h-52 flex items-center justify-center p-2 cursor-pointer"
          @click="openImage(img)"
        >
          <img
            :src="img.src"
        ...
        <div
          class="p-4 bg-[#1b2637] flex-1 flex flex-col justify-between border-t border-[#2f3f58]"
        >
          <div>
          ...
          <div
            class="mt-4 pt-3 border-t border-[#2f3f58] flex items-center justify-between"
          >
            <button
              @click="openImage(img)"
              class="text-xs text-amber-400 font-medium hover:underline flex items-center gap-1"
            >
            ...
            <a
              :href="img.src"
              download
              class="btn-secondary text-xs py-1 px-2.5 flex items-center gap-1"
            >
